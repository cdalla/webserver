...
Cgi::Cgi(Webserver *ptr, const char *script, char * const *env, const char *body) : _main(ptr), _pipeIn{-1,-1}, _pipeOut{-1,-1}, _env(env), _script(script), _body(body), _pos(0), _writeFinished(false)
{
    reset_last_activity();
